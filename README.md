...
На данный момент принимаю участие в разработке [сервиса для создания и редактирования резюме ](https://github.com/creating-and-editing-a-resume) в кросс-функциональной команде с участием тестировщиков, бэкенда, PM, аналитиков и дизайнеров.
